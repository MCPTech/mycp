	...
	function findAll_workflow(p){
		...
		for (i=0;i<p.length;i++)
		{
			...
			function after_updateCloudStatus(s){
				...
				if(status == 'running'){
					dwr.util.setValue('cloudStatus'+ip,'<img title="Running" alt=loading src=../images/running.png>',{ escapeHtml:false });	
				}else if(status == 'unreachable'){
					dwr.util.setValue('cloudStatus'+ip,'<img title="Warning" alt=loading src=../images/warning.png>',{ escapeHtml:false });	
				}else if(status == 'unknown'){
					dwr.util.setValue('cloudStatus'+ip,'<img title="Unknown" alt=loading src=../images/unknown.png>',{ escapeHtml:false });
				}
...
<div class="grid">
					...
					<!-- <span id="cloud"></span> -->
						...
						<tr>
							<td width="50%">Departments </td><td width="50%"><span id="Departments"></span></td></tr>
						<tr>
							<td width="50%">Projects </td><td width="50%"><span id="Projects"></span></td></tr>
						<tr>
							<td width="50%">Users </td><td width="50%"><span id="Users"></span></td></tr>
						<tr>
							<td width="50%">Clouds </td><td width="50%"><span id="Clouds"></span></td></tr>
						<tr>
							<td width="50%">Products </td><td width="50%"><span id="Products"></span></td></tr>
						</tbody>
						</table>
					...
					<div class="grid3">
						...
						<tbody>
							...
							<tr><td align="left">Total</td><td><span id="totalCost"></span></td><td><span id="totalCostCurrency"></span></td><td></td><td></td></tr>
						</tbody>
						</table>
					
					</div>
					<div id="datatable-iaas-parent" class="grid4">
						<div class="productsDash">Your Requests</div>
						<div style="height: 10px;"></div>
