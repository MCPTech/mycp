...
//SETTING UP OUR POPUP
	...
	//alert(dwr.util.toDescriptiveString(p,3));
		...
		for (i=0;i<p.length;i++)
		{
			...
			oTable.fnAddData( [i+1,p[i].processId, p[i].status, p[i].asset,
			                   
			                   '<img alt="Edit" src=../images/edit.png onclick=edit_workflow('+p[i].id+')>&nbsp; &nbsp; &nbsp; '+
			                   '<img alt="Remove" src=../images/deny.png onclick=remove_workflow('+p[i].id+')>' ] );
		}
...
<div id="datatable-iaas-parent" class="infragrid2">
					<div id="datatable-iaas" >
						...
						<table align="right" border="0" width="100%">
							<tr>
								<td width="80%">
								<font color="green">Workflow -- Processes</font>
								</td>
								<td width="10%">
									<div class="demo" id="popupbutton_workflow"><button>Deploy Process</button></div>
								</td>
								<td width="10%">
									<div class="demo" id="popupbutton_workflowlist"><button>List Process</button></div>
								</td>
							</tr>
						</table>
